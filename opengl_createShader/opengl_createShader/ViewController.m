...
- (void)viewDidLoad {
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(GL_FLOAT)*7, BUFFER_OFFSET(0));
    glVertexAttribPointer(1, 4, GL_FLOAT, GL_FALSE, sizeof(GL_FLOAT)*7, BUFFER_OFFSET(sizeof ( GLfloat )*3));
